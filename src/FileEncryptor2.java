...
public class FileEncryptor2 {
    ...
    private static void encrypt(char[] skey, String plaintext, String ciphertext) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException {

        //This snippet is literally copied from SymmetrixExample
        SecureRandom sr = new SecureRandom();
        byte[] key = getBytes(String.valueOf(skey));
        ...
        try (InputStream fin = FileEncryptor2.class.getResourceAsStream(plaintext);
    ...
    private static void decrypt(char[] skey, String ciphertext, String plaintext) throws InvalidAlgorithmParameterException, InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException, IOException {
